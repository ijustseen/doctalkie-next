          ...
          <div className="space-y-10 max-w-3xl">
            <section id="introduction" className="space-y-4 scroll-mt-20">
              ...
              <p className="text-lg text-muted-foreground">
                ...
                will find everything you need to embed the chat widget or build
                your own chat interface using our tools.
              </p>
    ...
    <div className="my-chat-container">
      ...
      <div className="input-area">
        ...
        <button onClick={handleSend} disabled={isLoading || !input.trim()}>Send</button>
                  ...
                  <p className="text-sm text-muted-foreground pt-2">
                    Remember to replace the placeholder IDs and keys, and style
                    the elements (
